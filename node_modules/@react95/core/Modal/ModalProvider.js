...
var ModalProvider = function ModalProvider(_ref) {
  ...
  var _useState3 = (0, _react.useState)(undefined),
      ...
      activeWindow = _useState4[0],
      setActiveWindow = _useState4[1];

  var addWindows = function addWindows(window) {
    return setWindows(function (state) {
      return [].concat(_toConsumableArray(state), [window]);
    });
  };

  var removeWindows = function removeWindows(title) {
    return setWindows(function (state) {
